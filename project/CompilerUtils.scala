...
object CompilerUtils {
  ...
  def getCompilerInterface(
    ...
    val componentManager = new ZincComponentManager(
      launcher.globalLock,
    ...
    val binSeparator =
      "-bin_" // Keep in sync with `ZincComponentCompiler.binSeparator`
